...
from form_analyser.services.parser_service import ParserService, ParseTime, ParseDate, ParseNumbers, CurrencyParser, AbnParser
...
class ParserFactory:
    ...
    def create_parser(type: FieldParser) -> ParserService:
        if type == FieldParser.DATE:
            ...
            return ParseDate()
        elif type == FieldParser.TIME:
            logger.info("Time parser selected")
            return ParseTime()
